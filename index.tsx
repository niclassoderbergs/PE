...
export const groups = [
    { id: '1', title: 'Domän 1: Master Data', brsPrefixes: ['BRS-FLEX-1'], mpsPrefixes: ['MPS-FLEX-1'] },
    { id: '2', title: 'Domän 2: Avtal & marknad', brsPrefixes: ['BRS-FLEX-2'], mpsPrefixes: ['MPS-FLEX-2'] },
    { id: '3', title: 'Domän 3: Produkt & kvalificering', brsPrefixes: ['BRS-FLEX-3'], mpsPrefixes: ['MPS-FLEX-3'] },
    { id: '4', title: 'Domän 4: Nätbegränsningar', brsPrefixes: ['BRS-FLEX-4'], mpsPrefixes: ['MPS-FLEX-4'] },
    { id: '5', title: 'Domän 5: Baseline', brsPrefixes: ['BRS-FLEX-5'], mpsPrefixes: ['MPS-FLEX-5'] },
    { id: '6', title: 'Domän 6: Mätvärden', brsPrefixes: ['BRS-FLEX-6'], mpsPrefixes: ['MPS-FLEX-6'] },
    { id: '7', title: 'Domän 7: Verifiering & budgivning', brsPrefixes: ['BRS-FLEX-7'], mpsPrefixes: ['MPS-FLEX-7'] },
    { id: '8', title: 'Domän 8: Aktörsadministration', brsPrefixes: ['BRS-FLEX-8'], mpsPrefixes: ['MPS-FLEX-8'] }
];
...
const LoginPage = ({ onLogin }: { onLogin: (p: string) => void }) => {
  ...
  const handleLogin = () => {
    if (p === 'admin' || p === 'demo' || p === 'fis' || p === 'SVKFIS') {
        onLogin(p);
    } else {
        setErr(true);
    }
  ...
  return (
    <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'100vh', backgroundColor:'#f4f5f7', fontFamily: '"Segoe UI", sans-serif'}}>
      <div style={{backgroundColor:'white', padding:'48px', borderRadius:'8px', boxShadow:'0 4px 12px rgba(0,0,0,0.1)', textAlign:'center', width: '100%', maxWidth: '320px'}}>
        ...
        />
        {err && <div style={{color: '#bf2600', fontSize: '0.85rem', marginBottom: '16px'}}>Felaktigt lösenord</div>}
